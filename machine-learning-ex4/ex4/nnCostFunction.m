...
delta_acc_1 = zeros(size(Theta1));
delta_acc_2 = zeros(size(Theta2));
...
for i = 1: m
  ...
  delta_acc_1 = delta_acc_1 + delta_2(2:end)' * a1;
  delta_acc_2 = delta_acc_2 + delta_3' * a2;
end;
